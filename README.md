...
├── src/
│   ├── grounding/           # Layer 1: Retrieval-Augmented Generation
│   ├── structured/          # Layer 2: Structured Output with Pydantic
│   ├── verification/        # Layer 3: Citation, Numerical & Rule Checks
│   ├── evaluation/          # Layer 4: Scoring & Experiment Tracking
│   └── data_analysis/       # Corpus Statistics & Statistical Testing
├── tests/
├── data/
│   └── sample_corpus/
├── configs/
